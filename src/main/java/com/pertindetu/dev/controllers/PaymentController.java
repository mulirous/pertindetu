...
public class PaymentController {
  ...
  @GetMapping
  public ResponseEntity<ApiResponseDTO<List<PaymentResponseDTO>>> findAll() {
    List<PaymentResponseDTO> list = paymentService.findAll().stream().map(PaymentResponseDTO::new).toList();
