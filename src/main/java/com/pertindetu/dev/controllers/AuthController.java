...
public class AuthController {
  ...
  @ApiResponse(responseCode = "200", description = "Login authentication successfully retrieved", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ApiResponseDTO.class)))
  @PostMapping("/login")
  ...
  @ApiResponse(responseCode = "201", description = "Register  successfully retrieved", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ApiResponseDTO.class)))
