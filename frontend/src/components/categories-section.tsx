  ...
  return (
    <section className="py-8 px-4 sm:px-6 lg:px-8 border-b border-border bg-background">
      <div className="max-w-7xl mx-auto">
        {/* Title */}
        <h2 className="text-2xl font-bold text-foreground mb-6">Categorias Populares</h2>
          ...
          {categories.map((category) => {
            ...
            return (
              ...
              >
                ...
                <h3 className="font-semibold text-foreground text-base mb-1">{category.title}</h3>
